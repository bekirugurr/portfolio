...
const Skills = ({setActiveItem}) => {
  ...
  let tools =[['HTML5',HTML5], ['CSS3', CSS3], ['Javascript',Javascript], ['React',React], ['Redux',Redux], ['Tailwind',Tailwind], ['jQuery',jQuery], ['Bootstrap',Bootstrap], ['Python',Python], ['django',django], ['Firebase',Firebase], ['Formik',Formik], ['Github',Github], ['MaterialUI',MaterialUI], ['SQLite', SQLite], ['PostgreSQL',PostgreSQL],  ['Heroku',Heroku], ['Styled',StyledComponent]]  

  return (
    <div ref={ref} id="skills" className="min-h-screen font-body bg-green-200 sm:bg-red-300 md:bg-blue-300 lg:bg-yellow-300 xl:bg-white px-0 mx-0 pt-16 px-1 md:px-4 lg:px-12 pb-12 md:pb-24">
      ...
      <ul className="flex flex-row flex-wrap px-4 lg:px-24  mt-4 md:mt-10 mb-0 md:mb-2 overflow-hidden">
        ...
        {tools.map((item)=> 
        (<li key={item[1]} className="flex flex-col items-center  mx-3 my-3 md:mx-6 pb-6 relative">
          ...
          <motion.p className="text-gray-700 absolute bottom-0" animate={animationText}>{item[0]}</motion.p>
        </li>)
         )} 
        ...
        <li className="flex flex-col items-center my-2 mx-3 md:my-3 md:mx-6 pb-6 relative">
          ...
          <motion.p className="text-gray-700 absolute bottom-0" animate={animationText}>Postman</motion.p>
        </li>
        <li className="flex flex-col items-center my-2 mx-3 md:my-3 md:mx-6 pb-6 relative">
          ...
          <motion.p className="text-gray-700 absolute bottom-0" animate={animationText}>Sass</motion.p>
        </li>
        <li className="flex flex-col items-center my-2 mx-3 md:my-3 md:mx-6 pb-6 relative">
          ...
          <motion.p className="text-gray-700 absolute bottom-0" animate={animationText}>VSCode</motion.p>
        </li>
      </ul>
    </div>
  );
